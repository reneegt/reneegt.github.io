...
const translations = {
  en: {
    ...
    supply_result: "Identified $2.45M in potential working capital opportunity and modeled how improved supplier lead-time reliability could reduce safety stock while maintaining target service levels.", experience_eyebrow: "PROFESSIONAL JOURNEY", experience_heading: "Experience that<br><em>shapes the analysis.</em>", education_eyebrow: "EDUCATION", education_heading: "Continuous<br><em>learning.</em>", contact_eyebrow: "LET'S CONNECT", contact_heading: "Let's turn data into<br><em>business impact.</em>"
  }, es: {
    nav_about: "Sobre mí", nav_expertise: "Experiencia", nav_projects: "Proyectos", nav_experience: "Trayectoria", nav_contact: "Contacto", hero_eyebrow: "CIENCIA DE DATOS × NEGOCIO", hero_role: "Data Scientist | Analítica de Supply Chain y Compras", hero_text: "Combino ciencia de datos con más de una década de liderazgo en cadena de suministro y abastecimientos para transformar datos de negocio en decisiones accionables.", hero_projects: "Ver proyectos", download_cv: "Descargar CV", about_eyebrow: "SOBRE MÍ", about_heading: "Experiencia de negocio<br>con <em>ciencia de datos.</em>", expertise_eyebrow: "EXPERIENCIA", expertise_heading: "Dos disciplinas.<br><em>Una visión de negocio.</em>", projects_eyebrow: "PROYECTOS TÉCNICOS DESTACADOS", projects_heading: "Soluciones end-to-end con<br><em>contexto de negocio.</em>", projects_subtitle: "Proyectos de Data Science que conectan el análisis técnico con preguntas reales de negocio.", zuber_title: "Análisis de viajes compartidos – Zuber", zuber_description: "Analicé datos de viajes compartidos para identificar patrones en las preferencias de los pasajeros y evaluar el impacto de factores externos en los viajes.", technical_solution: "Solución técnica", zuber_bullet_1: "Recopilé y preparé datos utilizando SQL, web scraping y Python.", zuber_bullet_2: "Exploré patrones para comprender las preferencias de los pasajeros y los factores externos que afectan los viajes.", results_label: "Resultados:", zuber_result: "Desarrollé un análisis exploratorio estructurado para apoyar la interpretación de la actividad de viajes compartidos basada en datos.", view_project: "Ver proyecto", churn_title: "Predicción de fuga de clientes – Interconnect Telecom", churn_description: "Construí un flujo predictivo de machine learning orientado a identificar clientes con riesgo de abandono y apoyar decisiones de retención.", churn_bullet_1: "Preparé los datos con codificación, escalado y tratamiento de valores ausentes antes del entrenamiento.", churn_bullet_2: "Comparé múltiples algoritmos de clasificación mediante F1-Score, AUC-ROC y matriz de confusión.", churn_result: "Desarrollé un análisis predictivo y un reporte para stakeholders orientado a reducir la pérdida de clientes y maximizar el retorno de inversión.", supply_title: "Supply Chain Analytics – Pronóstico de Demanda y Optimización de Inventarios",

    supply_description: "Este proyecto me entusiasmó especialmente porque me permitió combinar mi experiencia profesional en Supply Chain y Procurement con Ciencia de Datos. Quise explorar cómo el análisis de datos, el pronóstico de demanda y la optimización de inventarios pueden transformar problemas reales de la cadena de suministro en decisiones más estratégicas.",

    supply_bullet_1: "Construí un análisis end-to-end que integra limpieza y exploración de datos, segmentación ABC-XYZ, pronóstico de demanda y optimización de inventarios.",

    supply_bullet_2: "Evalué riesgo de inventario, comportamiento de stockouts, variabilidad de proveedores y oportunidades de capital de trabajo para generar recomendaciones accionables.",

    supply_result: "Identifiqué aproximadamente $2.45M USD en oportunidad potencial de capital de trabajo, al mismo tiempo que detecté $1.21M USD de exposición en materiales que podrían requerir mayor protección de inventario." experience_eyebrow: "TRAYECTORIA PROFESIONAL", experience_heading: "Experiencia que<br><em>fortalece el análisis.</em>", education_eyebrow: "FORMACIÓN", education_heading: "Aprendizaje<br><em>continuo.</em>", contact_eyebrow: "CONECTEMOS", contact_heading: "Convirtamos los datos en<br><em>impacto de negocio.</em>"
  }
